...
const LoginForm: React.FC<LoginFormProps> = ({ onSubmit }) => {
    ...
    return (
        <div className="p-8 rounded-2xl backdrop-blur-sm bg-black/50 border border-white/10 w-full">
            <div className="mb-8 text-center">
                ...
                <div className="text-white/80 flex flex-col items-center space-y-1">
                    ...
                    <div className="flex space-x-2 text-xs text-white/40 pt-2">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                    ...
                    className={`w-full py-3 rounded-lg ${isSuccess
                        ? 'bg-green-500' // Simple green for now as animate-success might not be defined
